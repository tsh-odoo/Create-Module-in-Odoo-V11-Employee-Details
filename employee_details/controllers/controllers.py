...
class EmployeeDetails(http.Controller):
    ...
    def list(self, **kw):
        name = http.request.env['employee.details'].search([])
        return http.request.render('employee_details.employee_list', {
            'employees': name,
        })
    ...
    def detail(self, employee=None, **kw):
        ...
        return http.request.render('employee_details.info', {
            'employee': employee
        })
    ...
    def get_employee_edit_form(self, employee_id=None, **kw):
        ...
        return http.request.env.ref('employee_details.employee_edit_form').render({'employee': employee})
    ...
    def get_employee_submit_form(self, **kw):
        ...
        return http.request.env.ref('employee_details.info').render({'employee': employee})
    ...
    def add_employee(self, **kw):
        http.request.env['employee.details'].create(kw)
        return True